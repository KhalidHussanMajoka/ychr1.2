...
<div class="py-md-5 pt-5 pb-4 w3l-singleblock1">
    <div class="container mt-md-3">
        <h3 class="blog-desc-big">Charity, Faith and hope, Help the poor, Help the Homeless. Charity Life</h3>
        <div class="blog-post-align">
            <div class="entry-meta">
                <span class="comments-link"> <a href="#reply">Leave a Comment</a> </span> /
                <span class="cat-links"><a href="#url" rel="category tag">Uncategorized</a></span> /
                <span class="posted-on"><span class="published"> August 18, 2020</span></span>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="container pb-lg-4">
            <div class="single-post-image">
                <div class="post-content">
                    <img src="assets/images/innerbanner.jpg" class="radius-image-full img-fluid mb-5" alt="" />
                </div>
            </div>
            <div class="single-post-content">
                ...
                <blockquote class="blockquote my-5">
                    ...
                    We are proud of Ray’s and Albert’s leadership over many years in achieving much good work in our
                    names in such a remote part of the world.
                ...
                <div class="sing-post-thumb mb-5 row pt-3">
                    <div class="col-sm-6">
                        <a href="#url"><img src="assets/images/blog3.jpg" class="img-fluid radius-image" alt=""></a>
                    </div>
                    <div class="col-sm-6 mt-sm-0 mt-3">
                        <a href="#url"><img src="assets/images/blog4.jpg" class="img-fluid radius-image" alt=""></a>
                    </div>
                </div>
                ...
                <p class="mb-4">Vivamus a ligula quam. Ut blandit eu leo non suscipit. <a href="#"
                        class="use-admin">Homeless</a> In interdum ullamcorper dolor eu mattis.Nulla quis lorem
                    neque,Nulla
                ...
                <nav class="navigation post-navigation my-4" role="navigation" aria-label="Posts">
                    <div class="nav-links">
                        <div class="nav-previous"><a href="#url" rel="prev">
                                <span class="ast-left-arrow">←</span> Previous Post</a>
                        </div>
                        <div class="nav-next text-right"><a href="#url" rel="next">
                                Next Post <span class="ast-right-arrow">→</span></a>
                        </div>
                    </div>
                </nav>
                ...
                <div class="author-card mt-5">
                    <div class="row align-items-center">
                        <div class="author-left col-md-3">
                            <a href="#author">
                                <img class="img-fluid radius-image" src="assets/images/team1.jpg" alt=" author image">
                            </a>
                        </div>
                ...
                <div class="comments mt-5 pt-lg-4">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing. Ea consequuntur illum facere aperiam
                                sequi optio consectetur adipisicing elitFuga,
                ...
                <div class="leave-comment-form mt-5 pt-lg-4" id="reply">
                    ...
                    <form action="#" method="post">
                        ...
                        <div class="form-group">
                            <textarea name="Comment" class="form-control" placeholder="Your Comment*" required=""
                ...
                <div class="item mt-5 pt-lg-5">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="list-view list-view1">
                                <div class="grids5-info">
                                    <a href="blog-single.html" class="d-block zoom"><img src="assets/images/blog5.jpg"
                                            alt="" class="img-fluid radius-image news-image"></a>
                                    <div class="blog-info align-self">
                                        <a href="blog-single.html" class="blog-desc1">Request for an audience with First Lady Melania
                                        </a>
                        ...
                        <div class="col-md-6 mt-md-0 mt-5">
                            <div class="list-view list-view1">
                                <div class="grids5-info">
                                    <a href="blog-single.html" class="d-block zoom"><img src="assets/images/blog6.jpg"
                                            alt="" class="img-fluid radius-image news-image"></a>
                                    <div class="blog-info align-self">
                                        <a href="blog-single.html" class="blog-desc1">Charity, Faith and hope, Help the poor, Help the Homeless</a>
                                            <div class="entry-meta mb-3"> 
                                                <span class="cat-links"><a href="#url" rel="category tag">Uncategorized</a></span> / 
                                                <span class="posted-on"><span class="published"> August 18, 2020</span></span>
                                            </div>
          ...
          <div id="footers14-block">
              <div class="container">
                  ...
                  <div class="footers14-bottom d-flex">
                      <div class="copyright">
                          <p>© 2020 YCHR. All rights reserved. Design by <a href="https://aresync.com/"
...
<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/01-09-2020/savepoor-liberty-demo_Free/1012221799/web/blog-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Oct 2022 08:44:09 GMT -->
</html>